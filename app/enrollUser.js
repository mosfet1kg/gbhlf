...
async function main() {
  ...
  const caURL = ccp.certificateAuthorities['org1-ca.fin.ncp-hlf.ga:443'].url;
  ...
  const enrollment = await ca.enroll({ enrollmentID: 'admin', enrollmentSecret: 'P59vGkhApl6KFwuxqNWwnuBZ' });
